          ...
          <div className="clear-both mt-16 font-spartan">
            ...
            <div>
              ...
              <ul className="list-none text-xs space-y-3 text-slate-600 leading-relaxed p-0 m-0 break-words" style={{ textIndent: 0 }}>
                ...
                <li>Rice, M. L. (2013). Language growth and genetics of specific language impairment. <i>International Journal of Speech-Language Pathology</i>. <a href="https://doi.org/10.3109/17549507.2013.791465" target="_blank" rel="noopener noreferrer" className="text-[#2abcd4] hover:underline">doi:10.3109/17549507.2013.791465</a></li>
                <li>Rice, M. L., Taylor, C. L., & Zubrick, S. R. (2008). Language outcomes of 7-year-old children with or without a history of late language emergence at 24 months. <i>Journal of Speech, Language, and Hearing Research</i>. <a href="https://doi.org/10.1044/1092-4388(2008/029)" target="_blank" rel="noopener noreferrer" className="text-[#2abcd4] hover:underline">doi:10.1044/1092-4388(2008/029)</a></li>
                <li>McGregor, K. K., Oleson, J., Bahnsen, A., & Duff, D. (2013). Children with developmental language impairment have vocabulary deficits characterized by limited breadth and depth. <i>International Journal of Language & Communication Disorders</i>. <a href="https://doi.org/10.1111/1460-6984.12015" target="_blank" rel="noopener noreferrer" className="text-[#2abcd4] hover:underline">doi:10.1111/1460-6984.12015</a></li>
                <li>Rice, M. L., & Wexler, K. (1996). Toward tense as a clinical marker of specific language impairment in English-speaking children. <i>Journal of Speech and Hearing Research</i>. <a href="https://doi.org/10.1044/jshr.3906.1239" target="_blank" rel="noopener noreferrer" className="text-[#2abcd4] hover:underline">doi:10.1044/jshr.3906.1239</a></li>
                <li>Rice, M. L., Wexler, K., & Hershberger, S. (1998). Tense over time: The longitudinal course of tense acquisition in children with specific language impairment. <i>Journal of Speech, Language, and Hearing Research</i>. <a href="https://doi.org/10.1044/jslhr.4106.1412" target="_blank" rel="noopener noreferrer" className="text-[#2abcd4] hover:underline">doi:10.1044/jslhr.4106.1412</a></li>
                <li>Dockrell, J. E., Messer, D., George, R., & Wilson, G. (1998). Children with word-finding difficulties—prevalence, presentation and naming problems. <i>International Journal of Language & Communication Disorders</i>. <a href="https://doi.org/10.1080/136828298247731" target="_blank" rel="noopener noreferrer" className="text-[#2abcd4] hover:underline">doi:10.1080/136828298247731</a></li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div className="clear-both mt-16 font-spartan">
            ...
            <div>
              ...
              <ul className="list-none text-xs space-y-3 text-slate-600 leading-relaxed p-0 m-0 break-words" style={{ textIndent: 0 }}>
                ...
                <li>Leonard, L. B., Weismer, S. E., Miller, C. A., Francis, D. J., Tomblin, J. B., & Kail, R. V. (2007). Speed of processing, working memory, and language impairment in children. <i>Journal of Speech, Language, and Hearing Research</i>. <a href="https://doi.org/10.1044/1092-4388(2007/030)" target="_blank" rel="noopener noreferrer" className="text-[#2abcd4] hover:underline">doi:10.1044/1092-4388(2007/030)</a></li>
                <li>Norbury, C. F., & Bishop, D. V. M. (2003). Narrative skills of children with communication impairments. <i>International Journal of Language & Communication Disorders</i>. <a href="https://doi.org/10.1080/1368282031000121602" target="_blank" rel="noopener noreferrer" className="text-[#2abcd4] hover:underline">doi:10.1080/1368282031000121602</a></li>
                ...
                <li>Norbury, C. F. (2005). The relationship between theory of mind and metaphor: Evidence from children with language impairment and autistic spectrum disorder. <i>British Journal of Developmental Psychology</i>. <a href="https://doi.org/10.1348/026151005X26732" target="_blank" rel="noopener noreferrer" className="text-[#2abcd4] hover:underline">doi:10.1348/026151005X26732</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-8 animate-fadeIn">
          ...
          <div className="clear-both mt-16 font-spartan">
            ...
            <div>
              ...
              <ul className="list-none text-xs space-y-3 text-slate-600 leading-relaxed p-0 m-0 break-words" style={{ textIndent: 0 }}>
                <li>Catts, H. W., Fey, M. E., Tomblin, J. B., & Zhang, X. (2002). A longitudinal investigation of reading outcomes in children with language impairments. <i>Journal of Speech, Language, and Hearing Research</i>. <a href="https://pubmed.ncbi.nlm.nih.gov/12546484/" target="_blank" rel="noopener noreferrer" className="text-[#2abcd4] hover:underline">PMID: 12546484</a></li>
                ...
                <li>Shriberg, L. D., Tomblin, J. B., & McSweeny, J. L. (1999). Prevalence of speech delay in 6-year-old children and comorbidity with language impairment. <i>Journal of Speech, Language, and Hearing Research</i>. <a href="https://doi.org/10.1044/jslhr.4206.1461" target="_blank" rel="noopener noreferrer" className="text-[#2abcd4] hover:underline">doi:10.1044/jslhr.4206.1461</a></li>
                <li>Rice, M. L., Taylor, C. L., & Zubrick, S. R. (2008). Language outcomes of 7-year-old children with or without a history of late language emergence at 24 months. <i>Journal of Speech, Language, and Hearing Research</i>. <a href="https://doi.org/10.1044/1092-4388(2008/029)" target="_blank" rel="noopener noreferrer" className="text-[#2abcd4] hover:underline">doi:10.1044/1092-4388(2008/029)</a></li>
                <li>Rice, M. L., Wexler, K., & Hershberger, S. (1998). Tense over time: The longitudinal course of tense acquisition in children with specific language impairment. <i>Journal of Speech, Language, and Hearing Research</i>. <a href="https://doi.org/10.1044/jslhr.4106.1412" target="_blank" rel="noopener noreferrer" className="text-[#2abcd4] hover:underline">doi:10.1044/jslhr.4106.1412</a></li>
